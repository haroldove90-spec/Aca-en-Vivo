...
export function HotelCard({
  ...
  return (
    <div className="bg-white rounded-none shadow-lg overflow-hidden border border-gray-100 transition-all hover:shadow-xl w-full max-w-sm mx-auto">
      ...
      <div className="h-40 bg-[#142850] relative flex items-center justify-center">
        ...
        <div className="absolute top-3 right-3 bg-white/90 backdrop-blur px-2 py-1 rounded-none flex items-center gap-1 shadow-sm">
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-center justify-between bg-gray-50 p-3 rounded-none">
          <div className="flex items-center gap-2">
            <span className={cn("w-3 h-3 rounded-none", status.color)} />
        ...
        <button
          ...
          className={cn(
            "w-full py-3 rounded-none font-bold text-white transition-all active:scale-95 shadow-md",
            disponibles > 0 
