        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {MOCK_FAVORITES.map((fav) => (
            <motion.div 
              ...
              className="bg-white rounded-none overflow-hidden shadow-xl shadow-black/5 border border-gray-100 group"
            >
              <div className="aspect-video relative overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4">
                  <span className="px-3 py-1 bg-primary text-white rounded-none text-[9px] font-black uppercase tracking-widest shadow-lg">
                    {fav.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 space-y-4">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex items-center gap-1 bg-accent/10 px-2 py-1 rounded-none">
